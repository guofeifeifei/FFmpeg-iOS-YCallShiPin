...
typedef void(^FinishBlock) (NSError *error, NSString *videoPath, long int startCount, long int zCount);
...
@property(nonatomic, assign) long int countTime;
@property(nonatomic, assign)long int startTimeCount;
